...
cd calendar-backend
npm install
# Configure .env and Firebase credentials
npm run dev
```
...
For detailed setup instructions, configuration, and API documentation, see the respective README files linked above.
